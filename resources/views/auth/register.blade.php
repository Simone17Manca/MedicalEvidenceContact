<x-guest-layout>
    <style>
        .registration-shell:has(#account-professional:checked) .professional-fields {
            display: block;
        }

        .registration-shell:has(#account-business:checked) .business-fields {
            display: block;
        }
    </style>

    <div class="registration-shell min-h-screen bg-gray-100 px-4 py-8 sm:py-12">
                ...
                <section class="rounded-lg bg-white p-6 shadow-md">
                    ...
                    <div class="mt-6 space-y-3 text-sm text-gray-700">
                        <div class="rounded-md border border-gray-200 p-4">
                            ...
                            <p class="mt-1 text-gray-600">Dati personali, nazionalita e indirizzo completo per creare il profilo professionale.</p>
                        </div>
                        <div class="rounded-md border border-gray-200 p-4">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <fieldset>
                            ...
                            <div class="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2">
                                <label class="cursor-pointer rounded-md border border-gray-300 p-4 has-[:checked]:border-indigo-600 has-[:checked]:bg-indigo-50">
                                    <input id="account-professional" class="sr-only" type="radio" name="account_type" value="professional" @checked(old('account_type', 'professional') === 'professional')>
                                ...
                                <label class="cursor-pointer rounded-md border border-gray-300 p-4 has-[:checked]:border-indigo-600 has-[:checked]:bg-indigo-50">
                                    <input id="account-business" class="sr-only" type="radio" name="account_type" value="business" @checked(old('account_type') === 'business')>
                        ...
                        <fieldset class="professional-fields mt-6 hidden">
                            ...
                            <div class="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <x-input id="address_country" class="mt-1 block w-full" type="text" name="address_country" :value="old('address_country', 'Italia')" autocomplete="country-name" />
                                </div>

                                <div>
                                    <x-label for="address_city" value="Citta" />
                                    <x-input id="address_city" class="mt-1 block w-full" type="text" name="address_city" :value="old('address_city')" autocomplete="address-level2" />
                                </div>

                                <div>
                                    <x-label for="address_province" value="Provincia" />
                                    <x-input id="address_province" class="mt-1 block w-full" type="text" name="address_province" :value="old('address_province')" autocomplete="address-level1" />
                                </div>

                                <div>
                                    <x-label for="postal_code" value="CAP" />
                                    <x-input id="postal_code" class="mt-1 block w-full" type="text" name="postal_code" :value="old('postal_code')" autocomplete="postal-code" />
                                </div>

                                <div>
                                    <x-label for="street_address" value="Indirizzo" />
                                    <x-input id="street_address" class="mt-1 block w-full" type="text" name="street_address" :value="old('street_address')" autocomplete="street-address" />
                                </div>
                            </div>
                        </fieldset>

                        <fieldset class="business-fields mt-6 hidden">
                            <legend class="text-base font-semibold text-gray-900">Profilo azienda</legend>
                            <div class="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2">
                                <div class="sm:col-span-2">
                                    <x-label for="company_name" value="Nome azienda" />
                                    <x-input id="company_name" class="mt-1 block w-full" type="text" name="company_name" :value="old('company_name')" />
                                </div>
                                ...
                                <div>
                                    ...
                                    <x-input id="location" class="mt-1 block w-full" type="text" name="location" :value="old('location')" />
                                </div>

                                <div class="sm:col-span-2">
                                    <x-label for="employee_count" value="Numero dipendenti" />
                                    <x-input id="employee_count" class="mt-1 block w-full" type="number" min="1" name="employee_count" :value="old('employee_count')" />
                                </div>
                            </div>
                        </fieldset>
